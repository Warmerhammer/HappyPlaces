...
abstract class SwipeToDeleteCallback(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    ...
    private val backgroundColor = Color.parseColor("#ae0505")
    ...
    override fun onChildDraw(
        ...
        val editIconLeft = itemView.left + itemView.width - intrinsicWidth - editIconMargin
        val editIconRight = itemView.right - 150
